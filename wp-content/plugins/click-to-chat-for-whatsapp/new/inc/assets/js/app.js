!function(t) {
    t((function() {
        var e = window.location.href
          ...
          , _ = {};
        function o() {
            localStorage.getItem("ht_ctc_storage") && (_ = localStorage.getItem("ht_ctc_storage"),
            _ = JSON.parse(_))
        }
        function i(t) {
            return !!_[t] && _[t]
        ...
        function d(e="open") {
            ...
            "init" == e ? t(".ht_ctc_chat_greetings_box").show(70) : t(".ht_ctc_chat_greetings_box").show(400),
        ...
        function g(e="close") {
            "element" == e ? t(".ht_ctc_chat_greetings_box").hide(70) : t(".ht_ctc_chat_greetings_box").hide(400),
        ...
        function p(t) {
            ...
            m(t)) : "show" == s.dis_d && ((e = document.querySelector(".ht_ctc_mobile_chat")) && e.remove(),
        ...
        function m(e) {
            ...
            !function() {
                if (t(".ht_ctc_chat_greetings_box").length) {
                    ...
                    s.g_init && "user_closed" !== i("g_user_action") && ("default" == s.g_init ? "yes" !== n && d("init") : "open" == s.g_init && d("init")),
        ...
        function f() {
            t(".for_greetings_header_image_badge").length && (t(".for_greetings_header_image_badge").addClass("g_header_badge_online"),
            t(".for_greetings_header_image_badge").show())
        }
        function v() {
            document.querySelector(".ht_ctc_notification") && (r("n_badge", "stop"),
            t(".ht_ctc_notification").remove())
        }
        function y(t) {
            ...
            if (s.ga) {
                ...
                h = n(h, a),
                l.g_an_params && l.g_an_params.forEach((t => {
                    if (l[t]) {
                        var e = l[t]
                          , c = e.key
                          , o = e.value;
                ...
                if ("undefined" != typeof dataLayer)
                    try {
                        ...
                        function p(t) {
                            ...
                            (t.startsWith("G-") || t.startsWith("GT-")) && (_.send_to = t,
                            gtag("event", h, _),
                            d++))
                        }
                        if (window.google_tag_data && window.google_tag_data.tidr && window.google_tag_data.tidr.destination)
                            for (var m in window.google_tag_data.tidr.destination)
                                p(m);
                ...
                if (0 == d && "no" == u)
                    if ("undefined" != typeof gtag)
                        ...
                        "undefined" != typeof __gaTracker && __gaTracker("send", "event", o, i, r)
            }
            ...
            s.fb && "undefined" != typeof fbq) {
                var f = s.pixel_event_name && "" !== s.pixel_event_name ? s.pixel_event_name : "Click to Chat by HoliThemes"
                  , v = l.pixel_event_type && "" !== l.pixel_event_type ? l.pixel_event_type : "trackCustom"
                  , y = {};
                l.pixel_params && l.pixel_params.forEach((t => {
                    if (l[t]) {
                        var e = l[t]
                          , c = e.key
                          , _ = e.value;
        ...
        function b(c) {
            ...
            c.hasAttribute("data-pre_filled") && (o = c.getAttribute("data-pre_filled"));
            try {
            ...
            if ("" != _) {
                ...
                "yes" == n ? (s.url_structure_m && (i = "whatsapp://send?phone=" + _ + "&text=" + o,
                r = "_self"),
                s.custom_url_m && "" !== s.custom_url_m && (i = s.custom_url_m)) : (s.url_structure_d && (i = "https://web.whatsapp.com/send?phone=" + _ + "&text=" + o),
                ...
                t(".ht-ctc-chat").html(a)
        }
        "undefined" != typeof ht_ctc_variables ? l = ht_ctc_variables : (l = {
        ...
        function() {
            ...
            e && (a = t(".ht_ctc_chat_data").attr("data-no_number"),
            e.remove())
        }(),
        ...
        (h = document.querySelector(".ht-ctc-chat")) && (document.dispatchEvent(new CustomEvent("ht_ctc_event_chat")),
        function(t) {
        ...
        t(document).on("click", ".ht_ctc_chat_greetings_box_link", (function(e) {
            e.preventDefault(),
            document.querySelector("#ctc_opt") ? t("#ctc_opt").is(":checked") || i("g_optin") ? (b(h),
            u()) : t(".ctc_opt_in").show(400).fadeOut("1").fadeIn("1") : (b(h),
            u()),
